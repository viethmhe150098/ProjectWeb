...
public class HomeControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DAOBanner daoBan = new DAOBanner(dbconn);
            ArrayList<Category> list = daoCate.getAllCategory();
            request.setAttribute("listCate", list);
            ArrayList<Product> listPro = daoPro.selectLast();
            request.setAttribute("listPro", listPro);
            ArrayList<Banner> listBan = daoBan.get3Banner();
