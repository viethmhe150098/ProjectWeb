 ...
 * @author Viet
 */
public class BannerControll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(service.equals("preAdd")){
                response.sendRedirect("AddBanner.jsp");
            }
            if(service.equals("add")){
                String bname = request.getParameter("bname");
                String bimages = request.getParameter("bimages");
                Banner ban = new Banner(bname, bimages);
                dao.addBanner(ban);
                response.sendRedirect("BannerControll");
            }
