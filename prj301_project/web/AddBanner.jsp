<%-- 
    Document   : AddBanner
    Created on : Jul 10, 2021, 3:42:46 PM
    Author     : Viet
--%>
    ...
    <body>
        ...
        <section>
            <div class="container">
                ...
                <div class="col-sm-6">
                    <form action="BannerControll" method="POST">
                        <table border="0">
                            <caption><h1>Add Banner</h1></caption>
                            <tbody>
                                <tr>
                                    <td>Banner Name</td>
                                ...
                                <tr>
                                    <td>Banner Image</td>
                                    <td><input type="file" name="bimages" value="" required/></td>
                                </tr>
                            </tbody>
                        </table>
