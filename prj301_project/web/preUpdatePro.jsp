<%-- 
    Document   : preUpdatePro
    Created on : Jul 3, 2021, 8:56:45 PM
    Author     : Viet
--%>
            ...
            <div class="container">
                ...
                <div class="col-sm-6">
                    <form action="ControllerProduct" method="POST">
                        <table border="0">
                            <caption><h1>Update Product Information</h1></caption>
                            <tbody>
                                <tr>
                                    <td>Product ID</td>
                                ...
                                <tr>
                                    <td>Description</td>
                                    <td><input type="text" name="description" value="<%=pro.getDes()%>" required/></td>
                                </tr>
                                <tr>
                                    <td>Status</td>
